...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `students` WHERE CONCAT(`id`, `matricnumber`, `name`, `icnumber`, `registrationstatus`, `dob`, `gender`, `religion`,`nationality`, `phonenumber`, `email`, `address`, `faculty`, `programme`, `dateofenroll`, `gpa`) LIKE '%".$matricnumber."%'";
        ...
        <div class="page-wrapper">
            ...
            <input type="submit" name="search" value="Search"><br><br>
                ...
                <tr>
                    ...
                    <td><a href="popup.php#modal"><?php echo $row['gpa'];?></td>
                    <td align="center">
